...
Func _Android_GetProductManufacturer()
	If Not _Android_IsDeviceOnline() Then Return SetError(1, 0, "Unknown")
	Return _Android_GetProperty("ro.product.manufacturer")
EndFunc   ;==>_Android_GetProductManufacturer

Func _Android_GetProductModel()
	If Not _Android_IsDeviceOnline() Then Return SetError(1, 0, "Unknown")
	Return _Android_GetProperty("ro.product.model")
EndFunc   ;==>_Android_GetProductModel

Func _Android_GetProductName()
	If Not _Android_IsDeviceOnline() Then Return SetError(1, 0, "Unknown")
	Return _Android_GetProperty("ro.product.name")
EndFunc   ;==>_Android_GetProductName

Func _Android_GetProductDevice()
	If Not _Android_IsDeviceOnline() Then Return SetError(1, 0, "Unknown")
	Return _Android_GetProperty("ro.product.device")
EndFunc   ;==>_Android_GetProductDevice

Func _Android_GetProductID()
	If Not _Android_IsDeviceOnline() Then Return SetError(1, 0, "Unknown")
	If Not _Android_IsDeviceTablet() Then
		Return __Android_GenerateProductID(_Android_GetProductModel(), _Android_GetDeviceID())
	Else
		Return __Android_GenerateProductID(_Android_GetProductModel(), _Android_GetDeviceSerialNumber())
	EndIf
...
Func __Android_GenerateProductID($sDeviceModel, $sDeviceID)
	...
	$sMD5 = StringMid(_Crypt_HashData($sDeviceModel & $sDeviceID, $CALG_MD5), 3)
...
Func __HexEx($iDec)
	Local $sHexEx = Hex($iDec)
	While StringLeft($sHexEx, 1) = "0"
		$sHexEx = StringMid($sHexEx, 2)
		If StringLeft($sHexEx, 1) <> "0" Then ExitLoop
	WEnd
	Return $sHexEx
EndFunc   ;==>__HexEx
